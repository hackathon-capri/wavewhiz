<script setup>
  defineProps(['cart'])
  defineEmits(['increment-product' , 'decrement-product', 'hide-cart'])
</script>
        ...
        <tr v-for="product in cart.items" :key="product.id">
          ...
          <td>
            <div class="cart-item-quantity">
              <button @click="$emit('decrement-product', product)" class="plain">
                <span class="mdi mdi-minus" />
              </button>
              {{ product.quantity }}
              <button @click="$emit('increment-product', product)" class="plain">
                <span class="mdi mdi-plus" />
              </button>
            </div>
          </td>
          <td class="cart-item-subtotal">R$ {{ product.price * product.quantity }}</td>
        </tr>
      </tbody>
    </table>
